...
namespace Ambit.Common
{
    public class ProjectSession
    {
        ...
        /// <summary>
        /// Gets or sets the Aggregator's KVMartMobile Number.
        /// </summary>
        /// <value>The Aggregator KVMartMobile Number.</value>
        public static string KVMartMobile
        {
            get
            {
                if (HttpContext.Current.Session["KVMartMobile"] == null)
                {
                    return "KVMartMobile";
                }
                else
                {
                    return ConvertTo.String(HttpContext.Current.Session["KVMartMobile"]);
                }
            }

            set
            {
                HttpContext.Current.Session["KVMartMobile"] = value;
            }
        }

        public static PermissionAccess RolePermissions
        {
            get
            {
                ...
                {
                    return (PermissionAccess)HttpContext.Current.Session["RolePermissions"];
                }
            }
            set
            {
                HttpContext.Current.Session["RolePermissions"] = value;
            }
        }
